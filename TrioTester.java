...
public class TrioTester {
	...
	public static void main(String[] args) {
		...
		Trio<Integer> numberTrioOneConstructor = new Trio<Integer>(1);
		...
		System.out.println(numberTrioOneConstructor);
		...
		Trio<String> wordTrio1 = new Trio<String>("hello", "goodbye", "test");
		Trio<String> wordTrio2 = new Trio<String>("goodbye", "hello", "test");
		System.out.println("Trios the same? true: " + wordTrio1.equals(wordTrio2));		
		...
		System.out.println("wordTrio1 is not smaller or larger- should be 0: " + wordTrio1.compareTo(wordTrio2));
		Trio<String> wordTrio3 = new Trio<String>("nice", "apple", "ape");
		System.out.println("wordTrio3 is smaller should be a negative number: " + wordTrio3.compareTo(wordTrio1));		
	}
